...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white text-primary sticky top-0 z-50 shadow-sm border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex-shrink-0 flex items-center gap-3 z-50">
            ...
            <Link to="/" onClick={closeMenu} className="font-bold text-lg sm:text-xl tracking-wide uppercase text-primary">
      ...
      <div 
        ...
        } z-40 pt-24 px-6 pb-6 overflow-y-auto border-l border-gray-100`}
      >
        <div className="flex flex-col space-y-6 text-center text-primary">
          <Link to="/" onClick={closeMenu} className="text-xl font-medium hover:text-accent transition-colors border-b border-gray-200 pb-2">Home</Link>
          <Link to="/lawyers" onClick={closeMenu} className="text-xl font-medium hover:text-accent transition-colors border-b border-gray-200 pb-2">Lawyers</Link>
          <Link to="/institutions" onClick={closeMenu} className="text-xl font-medium hover:text-accent transition-colors border-b border-gray-200 pb-2">Institutions</Link>
          <Link to="/services" onClick={closeMenu} className="text-xl font-medium hover:text-accent transition-colors border-b border-gray-200 pb-2">Services</Link>
          <Link to="/resources" onClick={closeMenu} className="text-xl font-medium hover:text-accent transition-colors border-b border-gray-200 pb-2">Resources</Link>
          <Link to="/collaboration" onClick={closeMenu} className="text-xl font-medium hover:text-accent transition-colors border-b border-gray-200 pb-2">Collaboration</Link>
          <div className="pt-4">
            <Link 
              to="/contact" 
              onClick={closeMenu}
